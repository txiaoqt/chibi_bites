...
<section style="padding: 140px 20px; min-height: 80vh;">
    <div class="order-confirmation-container">
        ...
        <div class="order-confirmation-actions">
            ...
            <a href="<?php echo e(route('account')); ?>" class="action-btn action-btn-secondary">View Account</a>
        </div>
    </div>
</section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Christopher x Angel\Documents\chibi_bites\laravel\resources\views/order-confirmation.blade.php ENDPATH**/ ?>