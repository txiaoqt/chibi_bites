        ...
        <div class="auth-card">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" class="auth-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="<?php echo e(old('name')); ?>" required class="form-input" placeholder="Enter your full name">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="auth-footer">
                <p>Already have an account? <a href="<?php echo e(route('login')); ?>" class="auth-link">Sign in</a></p>
            </div>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Christopher x Angel\Documents\chibi_bites\laravel\resources\views/auth/register.blade.php ENDPATH**/ ?>