...
<section class="contact-container">
    ...
    <div class="location-box">
        ...
        <div class="map-container">
            <img src="<?php echo e(asset('images/storeloc.png')); ?>" alt="Store Location" class="map-placeholder">
        </div>
    </div>
</section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Christopher x Angel\Documents\chibi_bites\resources\views/contact.blade.php ENDPATH**/ ?>